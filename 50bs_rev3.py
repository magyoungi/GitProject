                                                ...
                                                if RSI(top)[-2] <= 53:
                                                    ...
                                                    while y == 5:
                                                        ...
                                                        if RSI(top)[-2] >= 70:
                                                            ...
                                                            past2 = pyupbit.get_ohlcv(top, "minute5")['volume'][-4:-1]
                                                            present2 = pyupbit.get_ohlcv(top, "minute5")['volume'][-1]
                                                            avg = sum(past) / len(past)
                                                            avg2 = sum(past2) / len(past2)
                                                            if present >= avg * 3 or present2 >= avg2 * 3:
                                                                while y == 6:
                                                                    nowhour = datetime.datetime.now()
                                                                    time.sleep((5 - nowhour.minute % 5) * 60 + 180)
                                                                    if RSI(top)[-2] >= 50:
